...
//
//
//import br.dev.pedrodavi.jenkins.pipeline.environment.EnvironmentUtils
//import br.dev.pedrodavi.jenkins.pipeline.utils.maps.MapMergeMode
//import org.jenkinsci.plugins.workflow.libs.Library
//import groovy.transform.Field
//import br.dev.pedrodavi.jenkins.pipeline.credentials.Credential
//import br.dev.pedrodavi.jenkins.pipeline.credentials.CredentialConstants
//import br.dev.pedrodavi.jenkins.pipeline.credentials.CredentialParser
//import br.dev.pedrodavi.jenkins.pipeline.environment.EnvironmentConstants
//import br.dev.pedrodavi.jenkins.pipeline.job.BuildParameterFactory
//import br.dev.pedrodavi.jenkins.pipeline.managedfiles.ManagedFile
//import br.dev.pedrodavi.jenkins.pipeline.managedfiles.ManagedFileConstants
//import br.dev.pedrodavi.jenkins.pipeline.managedfiles.ManagedFileParser
//import br.dev.pedrodavi.jenkins.pipeline.model.PatternMatchable
//import br.dev.pedrodavi.jenkins.pipeline.model.Result
//import br.dev.pedrodavi.jenkins.pipeline.model.Tool
//import br.dev.pedrodavi.jenkins.pipeline.scm.GitRepository
//import br.dev.pedrodavi.jenkins.pipeline.shell.CommandBuilderImpl
//import br.dev.pedrodavi.jenkins.pipeline.shell.GitCommandBuilderImpl
//import br.dev.pedrodavi.jenkins.pipeline.shell.MavenCommandBuilderImpl
//import br.dev.pedrodavi.jenkins.pipeline.shell.ScpCommandBuilderImpl
//import br.dev.pedrodavi.jenkins.pipeline.shell.ShellUtils
//import br.dev.pedrodavi.jenkins.pipeline.tools.ansible.Role
//import br.dev.pedrodavi.jenkins.pipeline.tools.ansible.RoleRequirements
//import br.dev.pedrodavi.jenkins.pipeline.utils.IntegrationTestHelper
//import br.dev.pedrodavi.jenkins.pipeline.utils.ListUtils
//import br.dev.pedrodavi.jenkins.pipeline.utils.NotificationTriggerHelper
//import br.dev.pedrodavi.jenkins.pipeline.utils.PatternMatcher
...
//import br.dev.pedrodavi.jenkins.pipeline.utils.maps.MapUtils
//import br.dev.pedrodavi.jenkins.pipeline.utils.resources.JsonLibraryResource
//import br.dev.pedrodavi.jenkins.pipeline.utils.resources.LibraryResource
//import br.dev.pedrodavi.jenkins.pipeline.versioning.ComparableVersion
//import br.dev.pedrodavi.jenkins.pipeline.versioning.IntegerItem
//import br.dev.pedrodavi.jenkins.pipeline.versioning.ListItem
//import br.dev.pedrodavi.jenkins.pipeline.versioning.StringItem
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.credentials") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.environment") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.job") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.managedfiles") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.model") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.scm") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.shell") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.tools") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.utils.logging") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.utils.maps") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.utils.resources") {
...
//  }
//
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.utils") {
...
//    }
//  }
//  integrationTestUtils.runTestsOnPackage("br.dev.pedrodavi.jenkins.pipeline.utils.versioning") {
//
//
