 ...
 * @see br.dev.pedrodavi.jenkins.pipeline.credentials.Credential
 * @see br.dev.pedrodavi.jenkins.pipeline.credentials.CredentialParser
 * @see JsonLibraryResource
 * @see br.dev.pedrodavi.jenkins.pipeline.credentials.CredentialConstants
 */
 ...
 * @see br.dev.pedrodavi.jenkins.pipeline.credentials.Credential
 * @see br.dev.pedrodavi.jenkins.pipeline.credentials.CredentialParser
 * @see br.dev.pedrodavi.jenkins.pipeline.utils.resources.JsonLibraryResource
 * @see br.dev.pedrodavi.jenkins.pipeline.credentials.CredentialConstants
 */
