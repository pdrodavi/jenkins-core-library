 ...
 *
 * @see PatternMatchable* @see br.dev.pedrodavi.devops.jenkins.pipeline.credentials.Credential* @see br.dev.pedrodavi.devops.jenkins.pipeline.managedfiles.ManagedFile
 */
